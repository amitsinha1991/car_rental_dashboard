...
new Lightpick({
    field: document.getElementById('asale-1'),
    singleDate: false,
    onSelect: function(start, end){
        document.getElementById('aresult-1').innerHTML = rangeText(start, end);
    }
});

new Lightpick({
    field: document.getElementById('asale-2'),
    singleDate: false,
    onSelect: function(start, end){
        document.getElementById('aresult-2').innerHTML = rangeText(start, end);
    }
});

new Lightpick({
    field: document.getElementById('asale-3'),
    singleDate: false,
    onSelect: function(start, end){
        document.getElementById('aresult-3').innerHTML = rangeText(start, end);
    }
});

new Lightpick({
    field: document.getElementById('asale-4'),
    singleDate: false,
    onSelect: function(start, end){
        document.getElementById('aresult-4').innerHTML = rangeText(start, end);
    }
});

new Lightpick({
    field: document.getElementById('asale-5'),
    singleDate: false,
    onSelect: function(start, end){
        document.getElementById('aresult-5').innerHTML = rangeText(start, end);
    }
});
